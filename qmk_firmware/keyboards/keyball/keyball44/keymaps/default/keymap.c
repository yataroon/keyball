...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [3] = LAYOUT_universal(
    ...
    KC_LEFT_SHIFT  ,  _______ , _______  , _______ , _______ , _______  ,                                         HYPR(KC_N)  , KC_LCBR  , KC_RCBR  , _______  , _______  , KC_RIGHT_SHIFT  ,
  ...
  [5] = LAYOUT_universal(
    ...
    KC_LEFT_SHIFT  ,  KC_SCLN , KC_Q  , KC_J , KC_K  , KC_X  ,                                         KC_B  , KC_M  , KC_W  , KC_V  , KC_Z  , _______  ,
              KC_LGUI,  KC_LALT,  LT(2, KC_LNG2), LT(3,KC_SPC),LT(1, KC_LNG1),                  LSFT_T(KC_BSPC),GUI_T(KC_ENT), _______,  _______  , KC_ESCAPE
  ),
  //   // keymap for default
  // [0] = LAYOUT_universal(
